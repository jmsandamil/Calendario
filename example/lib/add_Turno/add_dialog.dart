...
class AddToCalendarDialog extends StatefulWidget {
  ...
  AddToCalendarDialog({this.turno, this.calendarItem});
...
class CalendarItem {
  ...
  CalendarItem({this.id, this.beginDate, this.endDate, this.endMode, this.alertTime, this.repeatMode, this.repeatNumber, this.turno});
...
//      'care_affirmation': careAffirmation.toJson()
  ...
  //    careAffirmation: Event.fromJson(json['care_affirmation'])
    );
  }
